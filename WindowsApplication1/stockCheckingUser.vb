Public Class formSCheckingUser
    ...
    Private Sub picARestock_Click(sender As Object, e As EventArgs)
        RemoveHandler Me.FormClosing, AddressOf formSChecking_FormClosing
        Me.Close()
        formARestock.Show()
    End Sub

    Private Sub picSReport_Click(sender As Object, e As EventArgs)
        RemoveHandler Me.FormClosing, AddressOf formSChecking_FormClosing
        Me.Close()
        formTSales.Show()
    End Sub

    Private Sub picSChecking_Click(sender As Object, e As EventArgs)
        RemoveHandler Me.FormClosing, AddressOf formSChecking_FormClosing
        Me.Close()
        formGReport.Show()
    End Sub
    ...
    Private Sub Label2_Click(sender As Object, e As EventArgs) Handles picTSales.Click, Label2.Click
        RemoveHandler Me.FormClosing, AddressOf formSChecking_FormClosing
        Me.Close()
        formTSales.Show()
    End Sub
